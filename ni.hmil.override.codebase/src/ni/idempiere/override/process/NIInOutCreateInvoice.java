 ...
 */
public class NIInOutCreateInvoice extends SvrProcess
{
	/**	Shipment					*/
	...
	protected String doIt () throws Exception
	{
		...
		String SQL=
				  "SELECT  MAX(i.documentno) "
				 +"FROM 	M_InOut io "
				 +"		INNER JOIN  M_InOutLine iol on io.M_InOut_ID=iol.M_InOut_ID "
				 +"		INNER JOIN  M_MatchInv mmi on iol.M_InOutLine_ID=mmi.M_InOutLine_ID "
				 +"		INNER JOIN  C_InvoiceLine il on mmi.C_InvoiceLine_ID=il.C_InvoiceLine_ID "
				 +"		INNER JOIN  C_Invoice i on il.C_Invoice_ID=i.C_Invoice_ID "
				 +"WHERE 	io.M_InOut_ID=?";
		//
		String value=DB.getSQLValueString(get_TrxName(), SQL, p_M_InOut_ID);
	    if(value!=null)
	    	throw new IllegalArgumentException("!!!Acción cancelada!!!. Ya existe una Factura con número "+value+", asociada a este documento.");
